...
Name:           ros-rolling-rqt-image-overlay-layer
Version:        0.3.1
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS rqt_image_overlay_layer package
...
%description
Provides an rqt_image_overlay_layer plugin interface, and a template
